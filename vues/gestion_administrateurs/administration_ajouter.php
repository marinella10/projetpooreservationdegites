...
<form action="administration_ajouter.php.php"  id="form-login" method="post" enctype="multipart/form-data">
    <div class="text-center">
        <img src="image/logogite.jpg" alt="logo gites" title="gites">
    </div>
    ...
    <div class="d-flex justify-content-around">
        ...
        <a href="administration.php" class="btn btn-success">Annuler</a>
    </div>
